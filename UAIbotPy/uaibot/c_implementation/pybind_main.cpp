...
PYBIND11_MODULE(uaibot_cpp_bind, m) {
     ...
     py::class_<TaskDotResult>(m, "CPP_TaskDotResult")
         .def(py::init<>())
         .def_readonly("task", &TaskDotResult::task)
         .def_readonly("jac_task", &TaskDotResult::jac_task)
         .def_readonly("jac_task_dot", &TaskDotResult::jac_task_dot)
         .def("__str__", &TaskDotResult::toString)
         .def("__repr__", &TaskDotResult::toString);
